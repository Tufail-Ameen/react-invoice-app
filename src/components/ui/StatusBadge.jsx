...
const STATUS_MAP = {
  ...
  expired: { label: "Expired", className: "draftbtn", key: 1 },
  converted: { label: "Converted", className: "paidbtn", key: 3 },
  submitted: { label: "Submitted", className: "pendingbtn", key: 2 },
  active: { label: "Active", className: "paidbtn", key: 3 },
  inactive: { label: "Inactive", className: "draftbtn", key: 1 },
  completed: { label: "Completed", className: "paidbtn", key: 3 },
